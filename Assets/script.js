...
var display = document.getElementById('cityInfo')
var fiveSelect= document.getElementById('fiveDay')
var citySelect = document.getElementById('pastCities')
...
const getCityWeather = userInput =>{
  display.innerHTML = ''
  fetch(`https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=d6e876915cce97fab77b5912a1ed7e34`)
